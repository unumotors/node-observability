...
class Tracing {
  constructor(config = {}) {
    this.config = {
      ...
      mongoTracingEnabled: !process.env.TRACING_MONGO_DISABLED,
    ...
    const instrumentations = [
      ...
      getNodeAutoInstrumentations({
        ...
        '@opentelemetry/instrumentation-net': {
          enabled: false, // produces a bunch of useless traces
        },
        ...
        '@opentelemetry/instrumentation-mongodb': {
          ...
          enabled: this.config.mongoTracingEnabled,
        },
        // Mongoose
        // https://github.com/aspecto-io/opentelemetry-ext-js/tree/master/packages/instrumentation-mongoose
        '@opentelemetry/instrumentation-mongoose': {
          enabled: this.config.mongoTracingEnabled, // can optionally be disabled
